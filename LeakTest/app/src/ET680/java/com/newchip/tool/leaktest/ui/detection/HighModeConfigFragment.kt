...
class HighModeConfigFragment : BaseAppFragment<FragmentConfigBinding>() {
    ...
    override fun initView() {
        setTitle(R.string.high_mode_config)
        initClick()
    }
    ...
    private fun updateData(configInfo: ConfigLeakInfoBean) {
        LogUtil.i("kevin", "当前高压模式配置数据：$configInfo")
