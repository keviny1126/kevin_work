 ...
 *
 */
public class HTT2Tools {
	public static final String SERIALPORT_LIB = "serial_port";
	public static final String DEVICE_NAME = "/dev/ttyMSM3";
	public static final String VOLTAGE_SENSING_DEVICE_NAME ="/sys/devices/platform/soc/soc:gpio_keys/mes_status";
