 ...
 * @hide
 */
/*package*/ final class BluetoothBLEOutputStream extends AbstractPhysicsOutputStream {
    private BluetoothBLEManager mBluetoothBLEManager;

    BluetoothBLEOutputStream(BluetoothBLEManager s,IPhysicsOutputStreamBufferWrapper physicsOutputStreamBufferWrapper) {
    ...
    public void close() throws IOException {
    	mBluetoothBLEManager.outputStreamClose();
    }
     ...
     */
     public void write(byte[] b, int offset, int count) throws IOException {
        ...
        if(mPhysicsOutputStreamBufferWrapper!=null && mPhysicsOutputStreamBufferWrapper.isNeedWrapper()){
            ...
            mBluetoothBLEManager.write(wrapperBuffer, 0, wrapperBuffer.length);
        }
        else{
            mBluetoothBLEManager.write(b, offset, count);
        }
        if(MLog.isDebug) {
