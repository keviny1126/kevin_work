...
open class RetrofitSmartSafeManager {
    companion object {
        private const val BASE_URL = "https://dataapi.newsmartsafe.com"
        private const val BASE_URL_TEST = "https://datatest.newsmartsafe.com"
        private const val CONNECTED_TOME_OUT = 30L
        private const val WRITE_TOME_OUT = 30L
        private const val READE_TOME_OUT = 30L
        val instance: RetrofitSmartSafeManager by lazy(mode = LazyThreadSafetyMode.SYNCHRONIZED) {
            RetrofitSmartSafeManager()
        }
    }
