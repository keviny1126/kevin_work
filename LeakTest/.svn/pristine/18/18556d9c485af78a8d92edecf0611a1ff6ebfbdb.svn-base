...
import com.newchip.tool.leaktest.databinding.FragmentAgingBinding
...
class AgingLeakTestFragment : BaseAppFragment<FragmentAgingBinding>() {
    override fun getViewBinding(
        inflater: LayoutInflater,
        container: ViewGroup?
    ) = FragmentAgingBinding.inflate(inflater, container, false)

    val vm: AgingViewModel by viewModel()
