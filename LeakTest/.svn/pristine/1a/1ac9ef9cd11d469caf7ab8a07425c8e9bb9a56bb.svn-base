...
class LowModeFragment : BaseAppFragment<FragmentLeaktestModeBinding>() {
    ...
    override fun initData() {
        ...
        configInfo = vm.getLowConfigData()
    ...
    private fun initClick() {
        ...
        mVb.tvSettingClick.setOnClickListener {
            ...
            val action =
                LowModeFragmentDirections.actionLowModeFragmentToLowModeConfigFragment()
