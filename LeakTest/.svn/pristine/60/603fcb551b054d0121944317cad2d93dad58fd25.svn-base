 ...
 */
class ResistanceMeasureView @JvmOverloads constructor(
    context: Context?,
    ...
    private var mRadius // 画布边缘半径（去除padding后的半径）
            = 0
    private val mStartAngle = 210 // 起始角度
    private val mSweepAngle = 120 // 绘制角度
    ...
    private var mCreditValue = 550 // 信用分
    ...
    private fun init() {
        ...
        mBgColors = intArrayOf(
            ContextCompat.getColor(context, R.color.black_translucent),
    ...
    override fun onMeasure(widthMeasureSpec: Int, heightMeasureSpec: Int) {
        ...
        mCenterX = mCenterY
        mRectFProgressArc!![mPadding + mSparkleWidth / 2f
