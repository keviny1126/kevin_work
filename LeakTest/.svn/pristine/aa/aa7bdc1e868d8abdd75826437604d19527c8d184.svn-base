 ...
 * @hide
 */
/*package*/ final class SimulatorOutputStream extends AbstractPhysicsOutputStream {
    private SimulatorManager mSimulatorManager;

    SimulatorOutputStream(SimulatorManager s,IPhysicsOutputStreamBufferWrapper physicsOutputStreamBufferWrapper) {
    ...
    public void close() throws IOException {
        mSimulatorManager.outputStreamClose();
    }
     ...
     */
     public void write(byte[] b, int offset, int count) throws IOException {
        ...
        if(mPhysicsOutputStreamBufferWrapper!=null && mPhysicsOutputStreamBufferWrapper.isNeedWrapper()){
            ...
            mSimulatorManager.write(wrapperBuffer, 0, wrapperBuffer.length);
        }
        else{
            mSimulatorManager.write(b, offset, count);
        }
    }
